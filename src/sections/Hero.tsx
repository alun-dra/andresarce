...
import CivicBg from '../components/CivicBg'
    ...
    <section id="inicio" className="relative overflow-hidden pt-24 md:pt-28 pb-20 md:pb-28 min-h-[85vh]">
      ...
      <div className="container-default grid items-center gap-12 md:grid-cols-2">
        <div className="relative z-10">
          ...
          {/* H1 con keywords visibles */}
          <h1
            ref={titleRef}
            className="mt-4 text-5xl font-black leading-tight tracking-tight text-white sm:text-6xl"
          >
            <span className="block">Andrés <span className="relative text-[#FBA931]">
              Arce
              <span className="absolute -bottom-2 left-0 h-2 w-full rounded-full bg-[#FBA931]" />
            </span></span>
            <span className="mt-2 block text-2xl font-semibold text-white/90">
              candidato a diputado por Chile
            </span>
          </h1>
          ...
          <div ref={ctaRef} className="mt-7 flex flex-wrap items-center gap-4">
            ...
            >
              <svg className="-ml-0.5 h-5 w-5 text-[#182D56] transition-transform group-hover:translate-x-0.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <div ref={cardRef} className="mx-auto w-full max-w-md">
            <figure className="relative overflow-hidden rounded-3xl ring-1 ring-black/10 shadow-2xl shadow-black/40">
              <img
                ...
                alt="Retrato de Andrés Arce, candidato a diputado por el Distrito 12"
                className="h-[620px] w-full object-cover md:h-[660px]"
              />
            </figure>
          </div>
        </div>
